...
def initialize_streamline_grid_gpu(center, x, y, dimensions, n_samples, step_size):
    ...
    path_filter = generate_path_filter_gpu(random_max_samples,M)
    print(M, N)
...
def batched_filter_gpu(path_matrix, dumped_values, i, dimensions, M, path_filter, current=True):
    ...
    first_false = first_false_index_gpu(inside_box_mat)#.cpu().numpy()
    ...
    outside_box_filter = generate_path_filter_gpu(first_false,M)
