...
def main():
    ...
    path_matrix, transformation_matrix, M, path_filter, random_max_samples = initialize_streamline_grid_gpu(center, x_vec_pt, y_vec_pt, dimensions, n_samples, step_size)
