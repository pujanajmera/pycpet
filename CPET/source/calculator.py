...
class calculator:
    ...
    def compute_topo_GPU_batch_filter(self):
        ...
        path_matrix_torch = torch.tensor(np.zeros((self.GPU_batch_freq, self.n_samples, 3)), dtype=torch.float64).cuda()
        ...
        random_max_samples-1, torch.tensor([M + 2], dtype=torch.int64).cuda()
        )
