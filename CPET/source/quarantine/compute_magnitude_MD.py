...
parser = argparse.ArgumentParser(
    description="This script computes a field in a box volume with given density"
)
...
grid_points, transformation_matrix = initialize_grid(
    center, x, y, density, dimensions, offset
)
